...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent mb-3 sm:mb-4 px-4">
            Get In <span className="bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent">Touch</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-orange-500/5 border border-orange-400/20 rounded-2xl p-8"
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-orange-500/5 border border-orange-400/20 focus:border-orange-400/40 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all text-orange-100 placeholder-orange-200/40"
                />
                {errors.name && (
              ...
              <div>
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-orange-500/5 border border-orange-400/20 focus:border-orange-400/40 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all resize-none text-orange-100 placeholder-orange-200/40"
                />
                {errors.message && (
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 disabled:from-gray-400 disabled:to-gray-500 text-black px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-orange-500/50 transition-all duration-300"
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-orange-200/80">{PERSONAL_INFO.email}</p>
                </div>
              </motion.a>

              <motion.a
                href={`tel:${PERSONAL_INFO.phone}`}
                className="flex items-center space-x-4 p-4 bg-orange-500/5 border border-orange-400/20 rounded-xl hover:bg-orange-500/10 hover:border-orange-400/40 transition-colors"
                whileHover={{ scale: 1.02 }}
              >
                <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-orange-200/80">{PERSONAL_INFO.phone}</p>
                </div>
              </motion.a>
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-orange-100">WhatsApp</p>
                  <p className="text-orange-200/80">Connect with me on WhatsApp</p>
                </div>
              </motion.a>
            </div>
          </motion.div>
